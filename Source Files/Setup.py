...
img = PhotoImage(file="/Users/mufeedamir/Desktop/G-Code-Generator/Source Files/dir_in/logo1.png")
...
tb=Label(root, text ="@ Mufeed_Amir (2021-2022)",font=('italic',12,'bold'),foreground="#fdfaf6",background="#4aa96c")
